...
ActiveRecord::Schema.define(version: 20170405010019) do
  ...
  create_table "message_connections", force: :cascade do |t|
    t.integer "classroom_id", null: false
    t.integer "student_id",   null: false
    t.integer "message_id",   null: false
    t.index ["classroom_id"], name: "index_message_connections_on_classroom_id", using: :btree
    t.index ["message_id"], name: "index_message_connections_on_message_id", using: :btree
    t.index ["student_id"], name: "index_message_connections_on_student_id", using: :btree
  end
